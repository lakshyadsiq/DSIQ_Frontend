...
import { HelpCircle, ChevronDown, ArrowLeft, X, Mail, Paperclip, AlertTriangle, CheckCircle, Clock, Search, Filter, User, MessageSquare, Star } from 'lucide-react';
...
const HelpPage = () => {
  ...
  const submitTicket = (e) => {
    ...
    // Show toast message
    toast.success('Ticket submitted successfully!'); // Show success toast
